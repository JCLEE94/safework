...
from src.schemas.health_consultation import (ConsultationStatus,
                                             ConsultationType,
                                             HealthIssueCategory)
...
class HealthConsultation(Base):
    ...
    health_issue_category = Column(
        SQLEnum(HealthIssueCategory), nullable=True, index=True
    )
...
class ConsultationFollowUp(Base):
    ...
    consultation_id = Column(
        Integer, ForeignKey("health_consultations.id"), nullable=False, index=True
    )
