...
from src.models.health_education import EducationType, EducationMethod, EducationStatus
...
class AttendanceBase(BaseModel):
    ...
    satisfaction_score: Optional[int] = Field(None, ge=1, le=5, description="만족도점수")
