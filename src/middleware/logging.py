...
class SecurityLoggingMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app: ASGIApp):
        ...
        self.suspicious_patterns = [
            ...
            "../", "..\\", "/etc/passwd", "/proc/",  # Path traversal
        ]
    ...
    async def _check_security_threats(self, request: Request):
        ...
        for pattern in self.suspicious_patterns:
            if pattern.lower() in request_url.lower() or pattern.lower() in query_params.lower():
        ...
        if len(request_url) > 2048:
            logger.security_event(
                ...
                details={
                    ...
                    "url": request_url[:200] + "..." if len(request_url) > 200 else request_url,
                    "client_ip": request.client.host if request.client else None
                },
                severity="warning"
            )
