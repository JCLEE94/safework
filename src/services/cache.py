...
class CacheService:
    ...
    async def set(self, key: str, value: Any, ttl: Optional[int] = None) -> bool:
        ...
        try:
            ...
            await self.redis_client.setex(key, ttl or 3600, data)  # 기본 1시간
    ...
    def decorator(func: Callable):
        ...
        async def wrapper(*args, **kwargs):
            ...
            cache_key = cache_service._generate_key(
                f"query:{model_name}", *args, **kwargs
            )
...
async def set_session(
    session_id: str, data: Dict[str, Any], ttl: int = CacheTTL.SESSION
):
    """세션 데이터 저장"""
...
# PDF 캐싱 함수들
async def cache_pdf_result(
    form_id: str, data_hash: str, pdf_data: bytes, ttl: int = CacheTTL.PDF_RESULT
):
    """PDF 생성 결과 캐싱"""
