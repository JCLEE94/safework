...
async def run_all_tests():
    ...
    all_results = {"total_tests": 0, "passed": 0, "failed": 0, "modules": []}
    ...
    for module_name, module_path in test_modules:
        ...
        try:
            ...
            all_results["modules"].append({"name": module_name, "error": str(e)})
    ...
    for module in all_results["modules"]:
        if "error" in module:
            ...
            print(
                f"  {status} {module['name']}: {module['passed']}/{module['total']} passed"
            )
