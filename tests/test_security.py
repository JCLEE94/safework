...
from src.utils.security import (
    ...
    DataEncryption, InputSanitizer, generate_api_key,
    hash_api_key, mask_sensitive_data, is_safe_redirect_url
)
...
class TestUtilityFunctions:
    ...
    def test_generate_api_key(self):
        ...
        assert key1 != key2
        assert all(c in "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_" for c in key1)
