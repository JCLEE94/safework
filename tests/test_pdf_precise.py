...
class TestPrecisePDFProcessor:
    ...
    def test_field_label_detection(self, processor):
        ...
        assert processor._is_field_label("very long text that is not a field label") == False
        ...
        fields = [
            {
                'name': '이름',
                'type': 'text',
                'coordinates': {'x': 100, 'y': 100, 'width': 150, 'height': 20, 'page': 1},
                'confidence': 0.9,
                'method': 'pymupdf'
            },
            {
            ...
            },
            {
                'name': '날짜',
                'type': 'date',
                'coordinates': {'x': 100, 'y': 150, 'width': 150, 'height': 20, 'page': 1},
                'confidence': 0.85,
                'method': 'text_pattern'
            },
            {
                'name': '저신뢰도',
                'type': 'text',
                'coordinates': {'x': 100, 'y': 200, 'width': 150, 'height': 20, 'page': 1},
...
class TestAsyncOperations:
    ...
    async def test_async_pdf_filling(self, processor, sample_pdf_content):
        ...
        result = processor.fill_pdf_precisely(sample_pdf_content, field_data, field_mappings)
